...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"patient_container\">\n\n    <header (click)=\"OnClick()\">Patient Info</header>\n\n    <!----------------------------->\n\n    <div *ngIf=\"open == false\" class=\"cardback\">\n        <h6>A1C: {{this.sharedBin.a1c}}%</h6>\n        <h6>Newly Diagnosed: \n            <span *ngIf=\"this.sharedBin.newly_diagnosed === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.newly_diagnosed === false\">No</span>\n        </h6>\n        <h6>Has Symptoms: \n            <span *ngIf=\"this.sharedBin.have_symptoms === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.have_symptoms === false\">No</span>\n        </h6>\n        <h6>Weight: {{this.sharedBin.weight_kg}} kg, {{this.sharedBin.weight_lb}} lb</h6>\n        <h6>Current Insulin: {{this.sharedBin.insulin_current}}</h6>\n        <h6>Cholesterol: {{this.sharedBin.cholesterol}}</h6>\n        <h6>Past Heart Attack: \n            <span *ngIf=\"this.sharedBin.heart_attack === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.heart_attack === false\">No</span>\n        </h6>\n        <h6>EF: {{this.sharedBin.EF}}</h6>\n        <h6>Microalbuminuria: {{this.sharedBin.micro_album}}</h6>\n        <h6>Creatinine: {{this.sharedBin.creatinine}}</h6>\n        <h6>Blood Pressure: {{this.sharedBin.blood_pressure_syst}}/{{this.sharedBin.blood_pressure_dias}}</h6>\n        <h6>eGFR: {{this.sharedBin.eGFR}}</h6>\n    </div>\n\n    <!----------------------------->\n\n    <div *ngIf=\"open == true\" class=\"cardback\">\n\n        <!--A1C-->\n        <div class=\"choice_box\">\n            <p>A1C%: </p>\n            <input name=\"this.sharedBin.a1c\" [(ngModel)]=\"this.sharedBin.a1c\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.a1c\" [(ngModel)]=\"this.sharedBin.a1c\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--New Patient-->\n        <div class=\"choice_box\">\n            <p>New Patient: </p>\n            <label class=\"switch_container\">\n                <input type=\"checkbox\" [(ngModel)]=\"this.sharedBin.newly_diagnosed\" class=\"form-control\">\n                <span class=\"switch round\"></span>\n            </label>\n            <span *ngIf=\"this.sharedBin.newly_diagnosed === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.newly_diagnosed === false\">No</span>\n        </div>\n\n        <!--Symptoms-->\n        <div class=\"choice_box\">\n            <p>Showing Symptoms: </p>\n            <label class=\"switch_container\">\n                <input type=\"checkbox\" [(ngModel)]=\"this.sharedBin.have_symptoms\" class=\"form-control\">\n                <span class=\"switch round\"></span>\n            </label>\n            <span *ngIf=\"this.sharedBin.have_symptoms === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.have_symptoms === false\">No</span>\n        </div>\n\n        <!--Weight-->\n        <div class=\"choice_box\">\n            <p>Weight: </p>\n            <br>\n            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg:</p>\n            <input name=\"this.sharedBin.weight_kg\" [(ngModel)]=\"this.sharedBin.weight_kg\" class=\"form-control centered\" placeholder=\"---\">\n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.weight_kg\" [(ngModel)]=\"this.sharedBin.weight_kg\" \n                type=\"range\" min=\"5\" max=\"500\" value=\"50\" class=\"slider\" step=\"1\">\n            </div>\n            <br>\n            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lb:</p>\n            <input name=\"this.sharedBin.weight_lb\" [(ngModel)]=\"this.sharedBin.weight_lb\" class=\"form-control centered\" placeholder=\"---\">\n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.weight_lb\" [(ngModel)]=\"this.sharedBin.weight_lb\" \n                type=\"range\" min=\"5\" max=\"400\" value=\"50\" class=\"slider\" step=\"1\">\n            </div>\n        </div>\n\n        <!--Insulin-->\n        <div class=\"choice_box\">\n            <p>Current Insulin: </p>\n            <input name=\"this.sharedBin.insulin_current\" [(ngModel)]=\"this.sharedBin.insulin_current\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.insulin_current\" [(ngModel)]=\"this.sharedBin.insulin_current\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--Cholesterol-->\n        <div class=\"choice_box\">\n            <p>Cholesterol: </p>\n            <input name=\"this.sharedBin.cholesterol\" [(ngModel)]=\"this.sharedBin.cholesterol\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.cholesterol\" [(ngModel)]=\"this.sharedBin.cholesterol\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--Heart Attack-->\n        <div class=\"choice_box\">\n            <p>Past Heart Attack: </p>\n            <label class=\"switch_container\">\n                <input type=\"checkbox\" [(ngModel)]=\"this.sharedBin.heart_attack\" class=\"form-control\">\n                <span class=\"switch round\"></span>\n            </label>\n            <span *ngIf=\"this.sharedBin.heart_attack === true\">Yes</span>\n            <span *ngIf=\"this.sharedBin.heart_attack === false\">No</span>\n        </div>\n\n        <!--EF-->\n        <div class=\"choice_box\">\n            <p>EF: </p>\n            <input name=\"this.sharedBin.EF\" [(ngModel)]=\"this.sharedBin.EF\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.EF\" [(ngModel)]=\"this.sharedBin.EF\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--Micro Album-->\n        <div class=\"choice_box\">\n            <p>Microalbuminuria: </p>\n            <input name=\"this.sharedBin.micro_album\" [(ngModel)]=\"this.sharedBin.micro_album\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.micro_album\" [(ngModel)]=\"this.sharedBin.micro_album\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--Creatinine-->\n        <div class=\"choice_box\">\n            <p>Creatinine: </p>\n            <input name=\"this.sharedBin.creatinine\" [(ngModel)]=\"this.sharedBin.creatinine\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.creatinine\" [(ngModel)]=\"this.sharedBin.creatinine\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n        <!--Blood Pressure-->\n        <div class=\"choice_box\">\n            <p>Blood Pressure: {{this.sharedBin.blood_pressure_syst}}/{{this.sharedBin.blood_pressure_dias}}</p>\n            <br>\n            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Systolic:</p>\n            <input name=\"this.sharedBin.blood_pressure_syst\" [(ngModel)]=\"this.sharedBin.blood_pressure_syst\" class=\"form-control centered\" placeholder=\"---\">\n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.blood_pressure_syst\" [(ngModel)]=\"this.sharedBin.blood_pressure_syst\" \n                type=\"range\" min=\"90\" max=\"250\" value=\"50\" class=\"slider\" step=\"10\">\n            </div>\n            <br>\n            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Diastolic:</p>\n            <input name=\"this.sharedBin.blood_pressure_dias\" [(ngModel)]=\"this.sharedBin.blood_pressure_dias\" class=\"form-control centered\" placeholder=\"---\">\n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.blood_pressure_dias\" [(ngModel)]=\"this.sharedBin.blood_pressure_dias\" \n                type=\"range\" min=\"60\" max=\"140\" value=\"50\" class=\"slider\" step=\"1\">\n            </div>\n        </div>\n\n        <!--eGFR-->\n        <div class=\"choice_box\">\n            <p>eGFR: </p>\n            <input name=\"this.sharedBin.eGFR\" [(ngModel)]=\"this.sharedBin.eGFR\" class=\"form-control centered\" placeholder=\"---\">\n    \n            <div class=\"slider_container\">\n                <input name=\"this.sharedBin.eGFR\" [(ngModel)]=\"this.sharedBin.eGFR\" \n                type=\"range\" min=\"5\" max=\"12\" value=\"50\" class=\"slider\" step=\"0.1\">\n            </div>\n        </div>\n\n    \n    </div>\n\n</div>\n\n\n\n\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("h3, h5{\r\n    margin: 0px auto;\r\n    width: 75%;\r\n    display: block;\r\n    text-align: center;\r\n}\r\n\r\ninput {\r\n    margin: 10px 0px;\r\n}\r\n\r\n.choice_box p {\r\n    display: inline-block;\r\n}\r\n\r\n.centered {\r\n    text-align: center;\r\n    display: inline-block;\r\n    width: 60px;\r\n    height: 30px;\r\n}\r\n\r\n/* ----------SWITCH-------------*/\r\n\r\n.switch_container {\r\n    position: relative;\r\n    top: 1px;\r\n    margin: 0px 5px;\r\n    display: inline-block;\r\n    width: 40px;\r\n    height: 24px;\r\n  }\r\n\r\n/* Hide default HTML checkbox */\r\n\r\n.switch_container input {\r\n    opacity: 0;\r\n    width: 0;\r\n    height: 0;\r\n  }\r\n\r\n/* The switch */\r\n\r\n.switch {\r\n    position: absolute;\r\n    cursor: pointer;\r\n    top: 0;\r\n    left: 0;\r\n    right: 0;\r\n    bottom: 0;\r\n    background-color: gray;\r\n    transition: .4s;\r\n  }\r\n\r\n.switch:before {\r\n    position: absolute;\r\n    content: \"\";\r\n    height: 24px;\r\n    width: 24px;\r\n    left: 0px;\r\n    bottom: 0px;\r\n    background-color: white;\r\n    transition: .4s;\r\n  }\r\n\r\ninput:checked + .switch {\r\n    background-color: orange;\r\n  }\r\n\r\ninput:focus + .switch {\r\n    box-shadow: 0 0 1px orange;\r\n  }\r\n\r\ninput:checked + .switch:before {\r\n    transform: translateX(16px);\r\n  }\r\n\r\n/* Rounded sliders */\r\n\r\n.switch.round {\r\n    border-radius: 24px;\r\n  }\r\n\r\n.switch.round:before {\r\n    border-radius: 50%;\r\n  }\r\n\r\n/* ----------SLIDER-------------*/\r\n\r\n.slider_container {\r\n    padding-left: 5%;\r\n    padding-right: 5%;\r\n    display: inline-block;\r\n    width: 40%;\r\n}\r\n\r\n.slider {\r\n    -webkit-appearance: none;  /* Override default CSS styles */\r\n    -moz-appearance: none;\r\n         appearance: none;\r\n    width: 100%; /* Full-width */\r\n    height: 15px; /* Specified height */\r\n    background: #ffffff; /* Grey background */\r\n    outline: none; /* Remove outline */\r\n    opacity: 0.7; /* Set transparency (for mouse-over effects on hover) */ /* 0.2 seconds transition on hover */\r\n    transition: opacity .2s;\r\n}\r\n\r\n.slider:hover {\r\n    opacity: 1; /* Fully shown on mouse-over */\r\n}\r\n\r\n/* The slider handle */\r\n\r\n.slider::-webkit-slider-thumb {\r\n    -webkit-appearance: none; /* Override default look */\r\n    appearance: none;\r\n    width: 13px; /* Set a specific slider handle width */\r\n    height: 25px; /* Slider handle height */\r\n    background: gray; /* Green background */\r\n    cursor: pointer; /* Cursor on hover */\r\n    border-radius: 10px;\r\n}\r\n\r\n.slider::-moz-range-thumb {\r\n    width: 25px; /* Set a specific slider handle width */\r\n    height: 25px; /* Slider handle height */\r\n    background: #4CAF50; /* Green background */\r\n    cursor: pointer; /* Cursor on hover */\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
